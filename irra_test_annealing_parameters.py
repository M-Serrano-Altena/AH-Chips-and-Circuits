...
temperature_candidates = [500, 1000, 2000, 4000, 8000]
alpha_candidates = [0.9, 0.95, 0.975, 0.99, 0.999]
results = []

for temperature in temperature_candidates:
    for alpha in alpha_candidates:
        chip0 = chip_og
        irra_irra = IRRA.IRRA(chip= chip0, iterations=10, intersection_limit= 2, acceptable_intersection=100, simulated_annealing= True, temperature_alpha= alpha, start_temperature= temperature)
...
output_file = 'output/parameter_research/chip2w7_start_PseudoRandom.json'
