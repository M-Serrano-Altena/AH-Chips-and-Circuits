...
irra_irra = IRRA.IRRA(chip= chip0, iterations=10, intersection_limit= 2, acceptable_intersection=100, simulated_annealing= True, temperature_alpha= 0.9999, start_temperature= 500)
